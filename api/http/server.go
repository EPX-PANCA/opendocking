...
import (
	...
	"github.com/opendocking/opendocking/api/http/csrf"
	"github.com/opendocking/opendocking/api/http/handler"
	...
	dockerhandler "github.com/opendocking/opendocking/api/http/handler/docker"
	...
	kubehandler "github.com/opendocking/opendocking/api/http/handler/kubernetes"
	...
	sslhandler "github.com/opendocking/opendocking/api/http/handler/ssl"
	...
	edgestackservice "github.com/opendocking/opendocking/api/internal/edge/edgestacks"
	...
	k8s "github.com/opendocking/opendocking/api/kubernetes"
	...
	libhelmtypes "github.com/opendocking/opendocking/pkg/libhelm/types"
...
func (server *Server) Start(ctx context.Context) error {
	...
	if portainer.MessageOfTheDayURL != "" {
		motdSvc.Start(ctx)
	}
